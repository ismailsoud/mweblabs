...
export default function Hero() {
    return (
        <div className="lg:h-screen w-full flex flex-col lg:px-17 text-slate-300 lg:border-b-[1px] border-slate-400">
            <Navbar />
            <div className="flex-col h-full lg:flex-row flex items-center justify-center lg:px-36">
                <div className="hidden h-full lg:flex flex-col justify-center items-center">
                    <div className="h-2/3 flex items-center justify-center p-10">
                        <img
                            src={image2}
                            alt="Logo"
                            className="w-[27rem] h-min rounded-2xl"
                        />
                    </div>
                    <div className="w-full h-1/2 flexCenter leading-[1.4] uppercase">
                ...
                <div className="h-full w-full flex flex-col lg:justify-center lg:border-x-[1px] border-slate-400 space-y-5 px-5 lg:px-0 pt-14 lg:pt-0 "> 
                    ...
                    <div className="flex flex-col items-center justify-center lg:hidden pt-16 space-y-8">
                        <img
                            src={image3}
